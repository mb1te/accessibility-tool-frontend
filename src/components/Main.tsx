                    ...
                    >
                        <div className="popup-fade__popup">
                            <button className="popup-fade__popup-close" onClick={closeModal}>
                                <svg width="35" height="35" viewBox="0 0 43 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="popup-fade__inputs">
                                ...
                                <input type="text" id="name" className="modal-input" placeholder="Короткое название  (до 100 символов)"/>
                                ...
                                <input type="text" id="plt" className="modal-input" placeholder="Наименование (до 50 символов)"/>
                                ...
                                <textarea id="char" className="modal-input" placeholder="Описание ресурса. Дополнительная информация (до 200 символов)"></textarea>
                            </div>
